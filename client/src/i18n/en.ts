...
export const en = {
  ...
  'codexPlan.description': 'OpenAI rate-limit usage from the latest Codex session — plan type, percent used, time to reset.',
  'codexPlan.planLabel': 'Plan',
  'codexPlan.usedLabel': 'Used',
  ...
  'codexPlan.staleTooltip': 'Snapshot from {when} — older than 24h, your plan window may have reset since.',
