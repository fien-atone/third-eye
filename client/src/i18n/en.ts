...
export const en = {
  ...
  'projects.title': 'Projects registry',
  'projects.subtitle': 'Rename projects, pin favourites, drill into any of them',
  'projects.colName': 'Name',
  'projects.colAuto': 'Auto label',
  'projects.colCalls': 'Calls',
  'projects.colCost': 'Cost',
  'projects.colFirstSeen': 'Created',
  'projects.colLastSeen': 'Last updated',
  'projects.colActions': 'Actions',
  'projects.editTitle': 'Rename project',
  'projects.openProject': 'Open project',
  'projects.save': 'Save',
  'projects.cancel': 'Cancel',
  'projects.reset': 'Reset to auto',
  'projects.editPlaceholder': 'Custom name for this project',
  'projects.empty': 'No projects yet — run an ingest first',
  'projects.favorite': 'Pin to favorites',
  'projects.unfavorite': 'Unpin from favorites',
  'projects.searchPlaceholder': 'Search by name, auto-label, or path…',
  'projects.noMatches': 'No projects match your search',
  'projects.favoritesSection': 'Favorites',
  'projects.allSection': 'All projects',
  'projects.perPage': 'Per page',
  'projects.pageInfo': '{start}–{end} of {total}',
  'projects.first': 'First page',
  'projects.prev': 'Previous page',
  'projects.next': 'Next page',
  'projects.last': 'Last page',
  'projects.sessionLabel': 'Session',
  ...
  'panel.costByProject.help': 'Bar height shows total spend that period; colors show which projects you worked on. Top 8 projects by cost get their own color; the rest are grouped as "Other". Click any pill to drill into that project.',
